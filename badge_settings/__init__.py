"""Crash-visible bootstrap for the standalone Badge Settings app."""

import os
import sys


APP_DIR = "/system/apps/badge_settings"
...
try:
    import badge_settings_app as _main
except BaseException as error:
    _boot_error = error
    try:
        with open(ERROR_PATH, "w") as handle:
            handle.write("Badge Settings startup failed\n")
...
if _main is not None:
    ...
    def update():
        ...
        screen.text("Badge Settings failed", 4, 3)
